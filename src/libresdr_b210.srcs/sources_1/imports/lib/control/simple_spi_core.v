...
module simple_spi_core
    ...
    //hijack ad9361 control signal to force TXxA RXxA    
    wire [31:0] mosi_data_hijack;
    assign mosi_data_hijack = (mosi_data[8+8+:10]==10'h004)?((mosi_data&32'hff_ff_00_ff)|32'h00_00_03_00):mosi_data;
